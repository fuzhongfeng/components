...
(function (root, factory) {
    if (typeof module !== 'undefined' && module.exports) {
        ...
        root.MyPromise = factory.call(root);
    }
})(this, function () {
    'use strict';
    ...
    function MyPromise (fn) {
        if( !this instanceof MyPromise) throw new Error("this can't called as funciton");
    ...
    /*  then 方法 
        ...
        @return MyPromise  返回一个新的Promsie
    */
    MyPromise.prototype.then = function (onResolve,onReject) {
        var self = this;
        var _next = new MyPromise(); 
